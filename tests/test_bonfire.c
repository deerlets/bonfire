...
static void test_bonfire_servcall(void **status)
{
    ...
    //    exit_flag = 1;
    bonfire_servcall_async(
        bf_hello, "test://zerox", "hello", noserv_cb, bf_hello);
    bonfire_servcall_async(
        bf_hello, "test://zerox/t", "hello", hello_to_zerox_cb, bf_hello);
